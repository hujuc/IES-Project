...
export default function AutomatizeTV() {
    const [automatizations, setAutomatizations] = useState([
        { time: "08:00 AM", brightness: 50, volume: 30, action: "Turn On" }, // Automatização inicial
    ]);
    ...
    const [volume, setVolume] = useState(30); // Nível de volume
    const [action, setAction] = useState("Turn On"); // Ação (Turn On/Off)
    ...
    const handleBrightnessChange = (value) => {
        const brightnessValue = Math.max(10, Number(value)); // Garante que o mínimo seja 10
        setBrightness(brightnessValue);
    };

    const handleVolumeChange = (value) => {
        setVolume(Number(value)); // Atualiza o volume
    };
                ...
                {isAutomatizeOn && (
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <input
                                type="range"
                                min="0" // Valor mínimo para volume
                                max="100"
                                value={volume}
