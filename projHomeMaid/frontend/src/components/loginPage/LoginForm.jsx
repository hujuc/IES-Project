...
function LoginForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col items-center bg-gray-100 p-8 shadow-lg rounded-lg w-full max-w-sm mx-auto">
            ...
            {/* Password Input */}
            {!showResetEmail && (
                <div className="form-control w-full mb-6 relative flex">
                    <label className="label w-full">
                        <span className="label-text text-gray-700 w-full">Password</span>
                    </label>
                    <div className="flex w-full">
                        <input
                            ...
                            className="input input-bordered bg-gray-50 flex-grow"
                        />
                        <button
                            type="button"
                            onClick={togglePasswordVisibility}
                            className="flex items-center justify-center w-12 h-12 bg-gray-200 hover:bg-gray-300 rounded-r-md shadow"
                        >
                            {showPassword ? (
